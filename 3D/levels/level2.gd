...
@onready var platforms = get_tree().get_nodes_in_group("lvl2_platforms")
@onready var chests = get_tree().get_nodes_in_group("lvl2_chests")
@onready var enemies = get_tree().get_nodes_in_group("lvl2_enemies")
...
func _ready():
	...
	for enemy in enemies:
		if enemy.is_in_group("lvl2_height1_enemies"):
			height1_enemies += 1
		elif enemy.is_in_group("lvl2_height2_enemies"):
			height2_enemies += 1
		elif enemy.is_in_group("lvl2_height3_enemies"):
			height3_enemies += 1
